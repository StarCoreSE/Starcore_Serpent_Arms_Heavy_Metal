...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition SA_HMI_GrimlockII => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "K_SA_Launcher_FixedMountv2", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "Muzzle_GrimlockII_01",
                    "Muzzle_GrimlockII_02",
                    "Muzzle_GrimlockII_03",// Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A

                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "scope_GrimlockII", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "Grimlock-II", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                K_SA_MHI_GrimlockII_Standard,
                K_SA_MHI_GrimlockII_Standard_Shrap, // Must list all primary, shrapnel, and pattern ammos.
            },
