    ...
    partial class Parts {
        ...
        WeaponDefinition SA_HMI_Erebos => new WeaponDefinition
        {
            ...
            Targeting = new TargetingDef
            {
                ...
                MaxTrackingTime = 40, // After this time has been reached the weapon will stop tracking existing target and scan for a new one, only applies to turreted weapons
            ...
            HardPoint = new HardPointDef
            {
                ...
                Loading = new LoadingDef
                {
                    ...
                    DelayAfterBurst = 15, // How long to spend "reloading" after each burst. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
