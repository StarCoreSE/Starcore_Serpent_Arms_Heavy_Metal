...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef K_SA_Grimlock_Standard => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "K_Grimlock_S", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Grim-S", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                AmmoRound = "Grim_S_Terminal", // AmmoRound field of the ammo to spawn.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Armor = new ArmorDef
                {
                    ...
                    Light = 7f, // Multiplier for damage against light armor.
                    Heavy = 10f, // Multiplier for damage against heavy armor.
                ...
                Shields = new ShieldDef
                {
                    ...
                    BypassModifier = 0.7f, // If greater than zero, the percentage of damage that will penetrate the shield.
                },
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                AccelPerSec = 1450f, // Meters Per Second. This is the spawning Speed of the Projectile, and used by turning.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 5f, //
                        Width = 0.1f, //
                        Color = Color(red: 35, green: 0f, blue: 0f, alpha: 1f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 25, green: 0f, blue: 0f, alpha: 1f),
                        Back = false,
                        CustomWidth = 0.02f,
        ...
        private AmmoDef K_SA_GravityFissure => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "K_Grimlock_GravFissure", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Gravity Fissure", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.5f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "Gravity_Fissure_Terminal", // AmmoRound field of the ammo to spawn.
                Fragments = 1, // Number of projectiles to spawn.
                Degrees = 0, // Cone in which to randomize direction of spawned projectiles.
                Reverse = false, // Spawn projectiles backward instead of forward.
                DropVelocity = false, // fragments will not inherit velocity from parent.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Shields = new ShieldDef
                {
                    Modifier = 1f, // Multiplier for damage against shields.
                    Type = Default, // Damage vs healing against shields; Default, Heal
                    BypassModifier = 0.4f, // If greater than zero, the percentage of damage that will penetrate the shield.
                },
                DamageType = new DamageTypes // Damage type of each element of the projectile's damage; Kinetic, Energy
                {
                    Base = Kinetic, // Base Damage uses this
            ...
            Ewar = new EwarDef
            {
                ...
                */
                ...
                Field = new FieldDef
                {
                    ...
                    HideModel = false, // Hide the default bubble, or other model if specified.
                    ShowParticle = true, // Show Block damage effect.
                    TriggerRange = 150f, //range at which fields are triggered
                    Particle = new ParticleDef // Particle effect to generate at the field's position.
                    {
                        Name = "K_SA_GravField_I", // SubtypeId of field particle effect.
                        Extras = new ParticleOptionDef
                        {
                            Scale = 1, // Scale of effect.
                        },
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                {
                    Inaccuracy = 1f, // 0 is perfect, hit accuracy will be a random num of meters between 0 and this value.
                    Aggressiveness = 0.001f, // controls how responsive tracking is.
                    MaxLateralThrust = 0.001f, // controls how sharp the trajectile may turn
                    TrackingDelay = 30, // Measured in Shape diameter units traveled.
                    MaxChaseTime = 90, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                    OverideTarget = false, // when set to true ammo picks its own target, does not use hardpoint's.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ColorVariance = Random(start: 0f, end: 0.3f), // multiply the color by random values within range.
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 0.05f, //
                        Width = 0.1f, //
                        Color = Color(red: 90f, green: 90f, blue: 90f, alpha: 2f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "WeaponLaser", // Please always have this Line set, if this Section is enabled.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 90f, green: 90f, blue: 90f, alpha: 1f),
                        Back = false,
                        CustomWidth = 0.02f,
                        UseWidthVariance = false,
                        UseColorFade = true,
        ...
        private AmmoDef K_SA_KineticKill => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "K_Grimlock_GravFissure", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "KineticKill", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.5f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 200f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                ...
                Degrees = 320, // Cone in which to randomize direction of spawned projectiles.
                Reverse = false, // Spawn projectiles backward instead of forward.
                DropVelocity = false, // fragments will not inherit velocity from parent.
                Offset = 0f, // Offsets the fragment spawn by this amount, in meters (positive forward, negative for backwards), value is read from parent ammo type.
                Radial = 0f, // Determines starting angle for Degrees of spread above.  IE, 0 degrees and 90 radial goes perpendicular to travel path
                    ...
                    Types = new[] // List of blocks to apply custom damage multipliers to.
    {
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                TargetLossDegree = 0f, // Degrees, Is pointed forward
                TargetLossTime = 0, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                MaxLifeTime = 8500, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). Please have a value for this, It stops Bad things.
                AccelPerSec = 550f, // Meters Per Second. This is the spawning Speed of the Projectile, and used by turning.
        ...
        private AmmoDef K_SA_KineticKill_Shrap => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "K_Grimlock_S", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "KineticKillShrap", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.5f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "GrimStock_Shrap", // AmmoRound field of the ammo to spawn.
                Fragments = 30, // Number of projectiles to spawn.
                Degrees = 320, // Cone in which to randomize direction of spawned projectiles.
                Reverse = false, // Spawn projectiles backward instead of forward.
                DropVelocity = false, // fragments will not inherit velocity from parent.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxTrajectory = 3660f, // Max Distance the projectile or beam can Travel.
                DeaccelTime = 0, // 0 is disabled, a value causes the projectile to come to rest, spawn a field and remain for a time (Measured in game ticks, 60 = 1 second)
                GravityMultiplier = 0f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable. Natural Gravity Only.
                SpeedVariance = Random(start: 0, end: 0), // subtracts value from DesiredSpeed. Be warned, you can make your projectile go backwards.
                RangeVariance = Random(start: 0, end: 0), // subtracts value from MaxTrajectory
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ColorVariance = Random(start: 0.0f, end: 0.3f), // multiply the color by random values within range.
                    WidthVariance = Random(start: 0f, end: 0.15f), // adds random value to default width (negatives shrinks width)
                    Tracer = new TracerBaseDef
                    {
                        Enable = true,
        ...
        private AmmoDef K_SA_Grimlock_Standard_Terminal => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Grim_S_Terminal", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.5f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 5000f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
                    ...
                    Types = new[] // List of blocks to apply custom damage multipliers to.
    {
        ...
        private AmmoDef K_SA_GravityFissure_Terminal => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "K_Grimlock_GravFissure", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Gravity_Fissure_Terminal", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.5f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 200f, // Direct damage; one steel plate is worth 100.
            Mass = 0f, // In kilograms; how much force the impact will apply to the target.
                    ...
                    Types = new[] // List of blocks to apply custom damage multipliers to.
    {
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                DesiredSpeed = 900, // voxel phasing if you go above 5100
                MaxTrajectory = 15000f, // Max Distance the projectile or beam can Travel.
                DeaccelTime = 600, // 0 is disabled, a value causes the projectile to come to rest overtime, (Measured in game ticks, 60 = 1 second)
                GravityMultiplier = 0f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable. Natural Gravity Only.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 0.05f, //
                        Width = 0.1f, //
                        Color = Color(red: 15f, green: 15f, blue: 15f, alpha: 1f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "WeaponLaser", // Please always have this Line set, if this Section is enabled.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 20, // In Ticks. 1 = 1 Additional Tracer generated per motion, 33 is 33 lines drawn per projectile. Keep this number low.
                        Color = Color(red: 15f, green: 15f, blue: 15f, alpha: 1f),
                        Back = false,
                        CustomWidth = 0.02f,
                        UseWidthVariance = false,
                        UseColorFade = true,
        ...
        private AmmoDef K_SA_Grimlock_Shrap => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "GrimStock_Shrap", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.5f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
        ...
        private AmmoDef K_SA_Grimlock_Standard_EWAR => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "GrimStop", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            ...
            Ewar = new EwarDef
            {
                ...
                */
                ...
                Field = new FieldDef
                {
                    Interval = 14, // Time between each pulse, in game ticks (60 == 1 second), starts at 0 (59 == tick 60).
                    PulseChance = 100, // Chance from 0 - 100 that an entity in the field will be hit by any given pulse.
                    GrowTime = 30, // How many ticks it should take the field to grow to full size.
                    HideModel = false, // Hide the default bubble, or other model if specified.
                    ShowParticle = false, // Show Block daqmage effect.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                TargetLossDegree = 80f, // Degrees, Is pointed forward
                TargetLossTime = 0, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                MaxLifeTime = 611, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). time begins at 0 and time must EXCEED this value to trigger "time > maxValue". Please have a value for this, It stops Bad things.
