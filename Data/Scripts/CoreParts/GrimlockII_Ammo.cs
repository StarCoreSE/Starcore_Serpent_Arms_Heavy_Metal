...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef K_SA_MHI_GrimlockII_Standard => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "K_SA_GrimlockIIMag", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            ...
            BackKickForce = 90f, // Recoil. This is applied to the Parent Grid.
            ...
            {
                AmmoRound = "GrimIIS_Shrap", // AmmoRound field of the ammo to spawn.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                Smarts = new SmartsDef
                {
                    ...
                    MaxLateralThrust = 0.65, // controls how sharp the trajectile may turn
            ...
            {
                ModelName = "\\Models\\Ammo\\SA_Launcherv2_Missile_Large", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 13f, //
                        Width = 0.3f, //
                        Color = Color(red: 90f, green: 35f, blue: 0f, alpha: 2f), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 90, green: 0f, blue: 0f, alpha: 2f),
                        Back = false,
                        CustomWidth = 0,
        ...
        private AmmoDef K_SA_MHI_GrimlockII_Standard_Shrap => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "GrimIIS_Shrap", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
                    ...
                    Types = new[] // List of blocks to apply custom damage multipliers to.
          {
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                TargetLossDegree = 0, // Degrees, Is pointed forward
                TargetLossTime = 0, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                MaxLifeTime = 3200, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). Please have a value for this, It stops Bad things.
                AccelPerSec = 950f, // Meters Per Second. This is the spawning Speed of the Projectile, and used by turning.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        TextureMode = Normal,
                        DecayTime = 18, // In Ticks. 1 = 1 Additional Tracer generated per motion, 33 is 33 lines drawn per projectile. Keep this number low.
                        Color = Color(red: 22f, green: 35f, blue: 0f, alpha: 1),
                        Back = false,
                        CustomWidth = 0.25f,
                        UseWidthVariance = false,
                        UseColorFade = true,
